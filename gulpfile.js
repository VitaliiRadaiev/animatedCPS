...
let path = {
	...
	src: {
		...
		js: [src_folder + "/js/app.js", src_folder + "/js/vendors.js", src_folder + "/js/jQueryScripts.js", src_folder + "/js/map.js"],
	...
	watch: {
		...
		blockCss: src_folder + "/common/**/**/*.scss",
		blockJs: src_folder + "/common/**/**/*.js",
		blockHtml: src_folder + "/common/**/**/*.html",
	},
	clean: "./" + project_name + "/"
};
...
let build = gulp.series(gulp.parallel(html, css, js,), gulp.parallel(fontstyle));
